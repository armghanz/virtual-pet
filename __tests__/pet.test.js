...
describe("growUp", () => {
  ...
  it("throws an error if pet is dead", () => {
    ...
    expect(() => pet.growUp()).toThrow("(*_*) Your pet has died.");
  });
});
...
describe("Walk", () => {
  ...
  it("throws an error if pet is dead", () => {
    ...
    expect(() => pet.walk()).toThrow("(*_*) Your pet has died.");
  });
});
...
describe("Feed", () => {
  ...
  it("throws an error if pet is dead", () => {
    ...
    expect(() => pet.feed()).toThrow("(*_*) Your pet has died.");
  });
});
...
describe("checkUp", () => {
  ...
  it("throws an error if pet is dead", () => {
    ...
    expect(() => pet.checkUp()).toThrow("(*_*) Your pet has died.");
  });
});
